...
class Config:
    source_dir = 'data/split/2d_graphlet_fl/'
    output_dir = 'train_data/lab20'

    mode = 'test'  # [train/test/draw_acc_loss/draw_cm/draw_acc_loss_fl_server]

    model_file_name = 'cl_dnn'
    model_batch_size = 10000
    model_input_shape = 560
    model_dropout = 0
...
def test(config: Config):
    ...
    # get data
    x_test, y_test_onehot, labels = io_util.load_train_data_npz(dataset_test_fn, 42)
