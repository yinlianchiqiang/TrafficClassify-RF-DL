...
def train():
    ...
    x_train_g, tmp, tmp, tmp = io_util.load_data_2d_graphlet(dataset_train_fn, 42)
    x_val_g, tmp, tmp, tmp = io_util.load_data_2d_graphlet(dataset_val_fn, 42)
    del tmp
    ...
    trainer = TrainerAE(
        ...
        X_train=x_train_g, X_val=x_val_g,
