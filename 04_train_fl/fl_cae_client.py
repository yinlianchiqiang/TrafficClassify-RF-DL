...
class TestClient(fl.client.NumPyClient):
    def __init__(self, model_folder, model, x_train, x_val, idx):
        ...
        self.trainer.model.build((None, 1500, 1))
...
def main():
    ...
    x_train, y, l = io_util.load_train_data_npz(dataset_train_fn, 42, 2)
    x_test, y, l = io_util.load_train_data_npz(dataset_test_fn, 42, 2)
